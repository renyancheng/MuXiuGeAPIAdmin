...
?>';
            	...
            	$create_sql = array(
            		...
            		"CREATE TABLE `mxgapi_api` (`id` int(11) NOT NULL,`name` varchar(200) NOT NULL,`enname` varchar(200) NOT NULL,`desc` text NOT NULL,`url` varchar(200) NOT NULL,`format` varchar(200) NOT NULL,`method` varchar(200) NOT NULL,`example_url` varchar(200) NOT NULL,`request_parameter` text NOT NULL,`return_parameter` text NOT NULL,`error_code` varchar(255) NOT NULL,`PHP_example` text NOT NULL,`return` text NOT NULL,`time` int(20) NOT NULL,`access` int(20) NOT NULL DEFAULT '0',`status` int(10) NOT NULL DEFAULT '1') ENGINE=MyISAM DEFAULT CHARSET=utf8;",
